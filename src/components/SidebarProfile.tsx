...
const SidebarProfile : React.FC = () => {
    ...
    return (
        <div className='relative mt-3' ref={menuRef}>
            <div className='hover:bg-gray-800 transition rounded-full p-2 flex space-x-3 w-full items-center justify-between cursor-pointer relative' onClick={() => setIsOpen(!isOpen)}>
                <div>
